  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        elevation: 0.0,
        title: Text('اقتصاديات',style: TextStyle(fontSize: 22,fontFamily: 'Reem',color:Colors.red)),
        leading: InkWell(child:  Icon(Icons.notification_important,color: Colors.red), onTap: (){
           Navigator.push(context,MaterialPageRoute(builder: (context) => NewsModel(this.api,'أخبار عاجلة')  ));
        },),
          ...
          children: <Widget>[
            Expanded(
              child: Container(
                ...
                child: InkWell(
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => TodayModel(this.api)  ));
                  },
                   child: Column(
                              children: <Widget>[
                                Icon(Icons.today),
            ...
            Expanded(
              child: Container(
                ...
                padding: EdgeInsets.only(top:10),
                child: InkWell(
                  onTap: (){ Navigator.push(context,MaterialPageRoute(builder: (context) => CategoriesPage(this.api)  ));},
                  child: Column(
                  children: <Widget>[
...
class _HomeSlider extends StatelessWidget{
  ...
  bool _dataIsHere()
  {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  image: new NetworkImage('https://eqtisadiat.com/public/images/'+_new.image),
                )
              )
            ),
            Positioned(
              ...
              child: SizedBox(
                ...
                child: DecoratedBox(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(right: 15,left: 15,top:2 ,bottom: 2),
                    child: Text(
                    _new.category.nameAr,
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.white,fontFamily: 'Reem',fontSize: 10),
                  ),
                  ),
                ),
              ),
    ...
    return SizedBox(
      ...
      items: _dataIsHere() ? items : <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  fit: BoxFit.cover,
                  colorFilter: new ColorFilter.mode(Colors.black.withOpacity(0.4), BlendMode.dstATop),
                  image: new AssetImage('assets/img/placeholder.png'),
...
class _LatestNews extends StatelessWidget{
   ...
   final List<News>breaking;
   final String title;
   _LatestNews({Key key, @required this.breaking, @required this.title}) : super(key: key);
        ...
        if(this.breaking.length >= 10)
        {
          for(var _i = 0; _i<= 10 ; _i++)
          {
              Widget item =  ListTile(
                        ...
                        title: Text(this.breaking[_i].titleAr != null ? this.breaking[_i].titleAr : '',style: TextStyle(fontSize: 11,fontWeight: FontWeight.w800,fontFamily: 'Cairo'),),
                          subtitle: Text(this.breaking[_i].createAt != null ? this.breaking[_i].createAt : '' ,style: TextStyle(fontSize: 9,fontFamily: 'Cairo'),),
                          leading: FadeInImage.assetNetwork(
                           image: 'http://eqtisadiat.com/public/images/'+this.breaking[_i].image,
                           ...
                           fit: BoxFit.cover,
                            ...
                            onTap: (){
                             Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => NewPage(this.breaking[_i])),
                              );
                            },
                      );
                   items.add(item);  
                ...
                child: MediaQuery.removePadding(
                  ...
                  child: Scrollbar(
                    ...
                    child: ListView(
                            ...
                            children: _dataIsHere() ? items :  <Widget>[
                              ListTile(
                                  title: Text('',style: TextStyle(fontSize: 14),),
                                    subtitle: Text('',style: TextStyle(fontSize: 11),),
                                    leading: Image(
...
class _Videos extends StatelessWidget{
  ...
  final List<Video> videos;
    ...
    _Videos({Key key, @required this.videos,}) : super(key: key);
  ...
  Widget build(BuildContext context){
    return Directionality(
      ...
      child: Padding(
        ...
        children: _dataIn(context) ?  widgets :  <Widget>[
           Padding(
                    padding: EdgeInsets.all(10),
                    child: Container(
                    width: MediaQuery.of(context).size.width,
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(5),
                      child: Image.asset('assets/img/video-placeholder.jpg',fit: BoxFit.cover,),
                    ),
                  ),
          ...
          child:  ButtonBar(
            ...
            children: <Widget>[
              FlatButton( onPressed: (){
                  ...
                  Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Category(element)),
                              );
                },
                 child: Text(element.nameAr,style: TextStyle(fontFamily: 'Cairo',fontSize: 11,fontWeight: FontWeight.w600,color: Colors.black),),
...
class _LatestNews2 extends StatelessWidget{
  ...
  final List<News>breaking;
   final String title;
   _LatestNews2({Key key, @required this.breaking, @required this.title}) : super(key: key);
 @override
  Widget build(BuildContext context)
  {
    List<Widget> items = new List<Widget>();
       ...
       this.breaking.forEach((_new){
          ...
          children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    _new.category.nameAr,
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.white,fontFamily: 'Reem',fontSize: 6),
                  ),
                  ),
                ),
              ),
            ...
            Positioned(
              ...
              child: Text(_new.titleAr,
              textAlign: TextAlign.right,
              style: TextStyle(color: Colors.white,fontSize: 8, fontWeight: FontWeight.bold,fontFamily: 'Cairo' ),),
            )
          ],
        ),
          )
